...
!(function (w) {
  var e = {
    ...
    t = function (t, s) {
      (this.elmt = t),
        (this.settings = w.extend({}, e, w.vegas.defaults, s)),
        ...
        (this.support = {
          ...
          video: w.vegas.isVideoCompatible(),
        }),
  ...
  (t.prototype = {
    ...
    _goto: function (t) {
          ...
          setTimeout(function () {
            v &&
              (m.support.transition
                ...
                : i.fadeIn(y));
            for (var t = 0; t < r.length - m.settings.slidesToKeep; t++)
              r.eq(t).remove();
      ...
      var i,
        ...
        o,
        a,
        r = this.$elmt.children(".vegas-slide"),
        d = this.settings.slides[t].src,
        l = this.settings.slides[t].video,
      ...
      this.settings.firstTransition &&
        ...
        this.support.video && l
          ? (((o =
            ...
            (o.muted = void 0 === l.mute || l.mute),
            !1 === o.muted
              ? ((o.volume = 0), this._fadeInSound(o, y))
              : o.pause(),
            (n = w(o).addClass("vegas-video").css("background-color", p)),
            this.support.objectFit
              ? n
                  .css("object-position", c + " " + g)
                  .css("object-fit", u)
                  .css("width", "100%")
                  .css("height", "100%")
              : "contain" === u && n.css("width", "100%").css("height", "100%"),
            i.append(n))
          : ((a = new Image()),
            (e = w('<div class="vegas-slide-inner"></div>')
              .css("background-image", "url(" + d + ")")
              .css("background-color", p)
              .css("background-position", c + " " + g)),
            "repeat" === u
              ? e.css("background-repeat", "repeat")
              : e.css("background-size", u),
            this.support.transition &&
              b &&
              e
        ...
        f ? r.eq(f - 1).after(i) : this.$elmt.prepend(i),
        r.css("transition", "all 0ms").each(function () {
        ...
        m._timer(!1),
        o
          ? (4 === o.readyState && (o.currentTime = 0), o.play(), s())
          : ((a.src = d), a.complete ? s() : (a.onload = s));
    },
    _end: function () {
    ...
    options: function (t, s) {
      ...
      if ("object" == (void 0 === t ? "undefined" : _typeof(t)))
        this.settings = w.extend({}, e, w.vegas.defaults, t);
      else {
    ...
    (w.fn.vegas = function (s) {
      var i,
        e = arguments,
        n = !1;
      if (void 0 === s || "object" == (void 0 === s ? "undefined" : _typeof(s)))
    ...
    (w.vegas = {}),
    (w.vegas.defaults = e),
    (w.vegas.isVideoCompatible = function () {
